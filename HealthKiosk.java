...
public class HealthKiosk {
    public static void main(String[] args) {
        ...
        if (metricChoice == 1) {
            ...
            // Math.ceil rounds up (e.g., 2.1 becomes 3)
        ...
        // Generate 4 random digits from 3 to 9
